...
public class NotificationViewedCommandTests
{
    ...
    public async void WhenNotificationGetViewedBySameUser()
    {
        ...
        Assert.Null(helper.EssentialDb.UserNotifications.First(x => x.NotificationId == notification.NotificationId).ReadTs);
        ...
        Assert.NotNull(helper.EssentialDb.UserNotifications.First(x => x.NotificationId == notification.NotificationId).ReadTs);
    }
    ...
    public async void WhenNotificationAlreadyGetViewedBySameUser_ThrowNotAllowedException()
    {
        ...
        await Assert.ThrowsAsync<NotAllowedException>( () => 
            new NotificationViewedCommand.NotificationViewedHandler(helper.EssentialDb, GetCurrentUserInfo(seed.userId), mediatorMock.Object)
                .Handle(new NotificationViewedCommand(notification.NotificationId), default));
    }
    ...
    public async void WhenNotificationGetViewedDifferentUser_ThrowNotAllowedException()
    {
        ...
        await Assert.ThrowsAsync<NotAllowedException>( () => 
            new NotificationViewedCommand.NotificationViewedHandler(helper.EssentialDb, GetCurrentUserInfo(other.userId), mediatorMock.Object)
            .Handle(new NotificationViewedCommand(notification.NotificationId), default));
    }
