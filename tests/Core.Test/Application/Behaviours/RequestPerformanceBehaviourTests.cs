...
// {
//     private readonly Mock<ILogger<RequestPerformanceBehaviour<TestExampleQuery, Task>>> loggerMock;
//     private Mock<ICurrentUserInfo> userMock;
//
//
//     public RequestPerformanceBehaviourTests()
//     {
//         loggerMock = new Mock<ILogger<RequestPerformanceBehaviour<TestExampleQuery>>>();
//
...
//         
//         var behaviour = new RequestPerformanceBehaviour<TestExampleQuery>(loggerMock.Object, userMock?.Object);
//         
//         await behaviour.Handle(new TestExampleQuery(ms), () => , default);
//
