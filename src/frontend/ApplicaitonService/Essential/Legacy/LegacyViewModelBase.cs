...
[Obsolete("User injected service IServerOperation")]
public abstract class LegacyViewModelBase : INotifyPropertyChanged
{
    ...
    protected LegacyViewModelBase(IDevice device)
    {
        this.device = device;
    }
