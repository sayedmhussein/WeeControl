...
public class EssentialDbContext(DbContextOptions<EssentialDbContext> options) : DbContext(options), IEssentialDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new UserFeedEntityTypeConfig());

        modelBuilder.ApplyConfiguration(new PersonEntityTypeConfig());
        ...
        modelBuilder.ApplyConfiguration(new UserSessionLogEntityTypeConfig());
        ...
        else if (Database.IsSqlite()) ConfigureSqlite(modelBuilder);
    }
