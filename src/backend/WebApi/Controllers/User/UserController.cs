...
//     
//     [Authorize]
//     [HttpPatch(ApiRouting.Essential.User.ServerEndPoints.Password)]
//     [MapToApiVersion("1.0")]
...
//     
//     [AllowAnonymous]
//     [HttpPost(ApiRouting.Essential.User.ServerEndPoints.Password)]
//     [MapToApiVersion("1.0")]
//     [ProducesResponseType((int)HttpStatusCode.OK)]
//     [ProducesResponseType((int)HttpStatusCode.BadRequest)]
...
//     }
//     
//     [HttpGet(ApiRouting.Essential.User.ServerEndPoints.Notification)]
//     [MapToApiVersion("1.0")]
...
//     }
//
//     [HttpDelete(ApiRouting.Essential.User.ServerEndPoints.Notification + "/{id:guid}")]
//     [MapToApiVersion("1.0")]
