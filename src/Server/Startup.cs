...
using WeeControl.Server.Middlewares;
using WeeControl.Server.Persistence;
using WeeControl.Server.Services;
using WeeControl.Server.StartupOptions;
using WeeControl.SharedKernel.Security;

namespace WeeControl.Server
{
