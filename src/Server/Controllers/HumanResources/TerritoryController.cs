...
// using WeeControl.Application.HumanResources.Commands.AddTerritoryV1;
// using WeeControl.Application.HumanResources.Commands.DeleteTerritoryV1;
// using WeeControl.Application.HumanResources.Commands.UpdateTerritoryV1;
// using WeeControl.SharedKernel.Common.DtosV1;
//
// namespace WeeControl.Server.Controllers.HumanResources
// {
...
//         [ProducesResponseType(typeof(ResponseDto<IEnumerable<IdentifiedDto>>), (int)HttpStatusCode.OK)]
//         [ProducesResponseType((int)HttpStatusCode.NotFound)]
//         [ProducesResponseType((int)HttpStatusCode.BadRequest)]
//         [ProducesResponseType((int)HttpStatusCode.Unauthorized)]
//         [ProducesResponseType((int)HttpStatusCode.Forbidden)]
//         public Task<ActionResult<ResponseDto<IEnumerable<IdentifiedDto>>>> GetAllTerritoriesV1(Guid? id)
//         {
...
//         [ProducesResponseType((int)HttpStatusCode.Unauthorized)]
//         [ProducesResponseType((int)HttpStatusCode.Forbidden)]
//         public async Task<ActionResult> AddTerritoriesV1([FromBody] RequestDto<Dto> dto)
//         {
...
//         [ProducesResponseType((int)HttpStatusCode.Unauthorized)]
//         [ProducesResponseType((int)HttpStatusCode.Forbidden)]
//         public async Task<ActionResult> PutTerritoryV1(Guid id, [FromBody] RequestDto<Dto> requestDto)
//         {
