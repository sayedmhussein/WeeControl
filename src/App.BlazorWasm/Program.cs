...
using WeeControl.App.BlazorWasm.Services;
using WeeControl.App.Services.Authorization;
using WeeControl.SharedKernel;
using WeeControl.SharedKernel.Common.Interfaces;
using DependencyInjection = WeeControl.SharedKernel.Security.DependencyInjection;

namespace WeeControl.App.BlazorWasm
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.RootComponents.Add<WeeControl.App.BlazorWasm.App>("#app");
